  ...
  return (
    <div className="w-full sticky top-0 z-50 flex flex-col">
      ...
      <div className='flex  items-center gap-4 justify-center'>
            ...
            <a className=' text-[10px] md:text-xs font-thin ' href="https://risin.ventures/" target="_blank">Powered by <br /> <u className='font-bold text-gray-200'>Rising Ventures</u></a>
            </div>
