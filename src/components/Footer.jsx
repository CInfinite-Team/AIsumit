        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-8 mb-12">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              <li><a href="#about" className="hover:text-white transition-colors">About AI Hack</a></li>
              <li><a href="#Participate" className="hover:text-white transition-colors">Who can participate</a></li>
              <li><a href="#Experts" className="hover:text-white transition-colors">Experts Line-up</a></li>
              <li><a href="#" className="hover:text-white transition-colors">Prizes</a></li>
              <li><a href="#Partners" className="hover:text-white transition-colors">Partners</a></li>
              <li><a onClick={(e)=>handlenavigation(e,'FAQ')} className="cursor-pointer hover:text-white transition-colors">FAQ</a></li>
            </ul>
          </div>
