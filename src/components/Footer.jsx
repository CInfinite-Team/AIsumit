     ...
     <li>  <a className='cursor-pointer transition-colors hover:text-white inter' onClick={(e)=>handlenavigation(e,'spotlight')}>AI Spotlight</a></li>
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm">
              <li className="flex items-center gap-3"><div className='p-1 rounded-full bg-purple-700/20'><img src={Call} className='w-5' alt="" /></div> <a href="tel:+97444654622" ><span className='inter'>+974 4465 4622</span></a></li>
              <li className="flex items-center gap-3"><div className='p-1 aspect-square flex items-center rounded-full bg-purple-700/20'><img src={Mail} className='w-5' alt="" /></div> <a href="mailto:info@risin.ventures" ><span className='inter'>info@risin.ventures</span></a></li>
