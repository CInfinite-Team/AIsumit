      ...
      <div className="flex-1 order-2 xl:order-1 items-center lg:items-start flex flex-col gap-6 max-w-2xl">
        ...
        <div className="flex gap-6">
          ...
          <div className="flex items-center gap-2 px-8 py-1 rounded-md border border-cyan-500 bg-[#20113D]">
            <img src={HackIcon} alt="Hack Icon" className="w-12 h-12" />
            
          </div>
        </div>

        <h2 className=" font-light text-center lg:text-start">
          <span className="text-white">The </span>
          <span className=" font-bold">AI Summit </span>
          <span className="text-white">is a premier platform for C-suite leaders and decision-makers shaping AI-driven enterprise transformation. Alongside it, AI Hack fuels innovation through real-world challenges, insights, and strategic collaboration.</span>
        </h2>

        <p className="text-gray-300 flex items-start justify-start text-sm leading-relaxed">
         <img src={TickBullet} className='w-4 h-4 mt-1 mr-2' alt="" /> <span><strong >Bringing together</strong> C-level executives and innovation leaders, the summit tackles key enterprise priorities — from AI integration and data-driven growth to aligning innovation with sustainability and policy.</span>
        </p>

       <p className="text-gray-300 flex items-start justify-start text-sm leading-relaxed">
         <img src={TickBullet} className='w-4 h-4 mt-1 mr-2' alt="" /> <span><strong >Expect powerful keynotes,</strong> closed-door roundtables, curated networking, and actionable insights to lead in the era of intelligent transformation.</span>
        </p>

        <p className="text-gray-300 text-center lg:text-start text-sm font-light leading-relaxed">
