    ...
    <section className="w-full relative  min-h-screen px-4 md:px-20 py-10 [background:linear-gradient(180deg,#2B204C_0%,#160C35_50%)] text-white flex flex-col xl:flex-row gap-10 lg:gap-20 items-center justify-between">
      ...
      <div className="flex-1 order-2 xl:order-1 items-center lg:items-start flex flex-col gap-6 max-w-2xl">
        ...
        <div className="flex gap-6">
          <div className="inline-block rounded-md overflow-hidden w-fit p-[2px] bg-gradient-to-r from-pink-500 via-purple-500 to-cyan-400 shadow-[0px_16px_40px_0px_rgba(236,72,153,0.5)]">
            <button onClick={() => setChnageImg(false)} className="px-6 py-3 rounded-md transition-colors duration-300 hover:bg-[#3c3357] bg-[#2B204C] text-white font-semibold text-sm">
              AI Summit
            </button>
          </div>
          
           <div className="inline-block rounded-md overflow-hidden w-fit p-[2px] bg-gradient-to-r from-pink-500 via-purple-500 to-cyan-400 shadow-[0px_16px_40px_0px_rgba(236,72,153,0.5)]">
            <button onClick={() => setChnageImg(true)} className="px-6 py-3 rounded-md transition-colors duration-300 hover:bg-[#3c3357] bg-[#2B204C] text-white font-semibold text-sm">
              AI Hack
            </button>
          </div>
        </div>
      ...
      <div className="flex-1 order-1 xl:order-2  relative">
          ...
          <div className="rounded-2xl max-w-lg  p-3">
            <img src={!ChangeImg ?  AiIcon : HackIcon} alt="AI Robot" className="rounded-xl object-cover w-full" />
          </div>
